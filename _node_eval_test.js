var firebase = {
  apps: [],
  initializeApp: function() { this.apps.push({}); return this; },
  database: function() {
    return {
      ref: function() {
        return {
...
var window = global;
var document = {
  createElement: function() { return {textContent:'',innerHTML:'',style:{},appendChild:function(){},addEventListener:function(){},classList:{add:function(){},remove:function(){},toggle:function(){},contains:function(){return false}}}; },
  getElementById: function() { return {textContent:'',innerHTML:'',style:{},value:'',checked:false,addEventListener:function(){},removeEventListener:function(){},classList:{add:function(){},remove:function(){},toggle:function(){},contains:function(){return false}},querySelector:function(){return null},querySelectorAll:function(){return[]}}; },
...
var _origConsole = global.console;
var console = {log:function(){_origConsole.log.apply(_origConsole,arguments);},warn:function(){_origConsole.warn.apply(_origConsole,arguments);},error:function(){_origConsole.error.apply(_origConsole,arguments);},info:function(){_origConsole.info.apply(_origConsole,arguments);},debug:function(){}};
...
try {
  eval(require('fs').readFileSync('E:\\FC26传奇联赛\\deploy\\_tmp_code.js','utf8'));
  console.log('EVAL_OK: typeof doLogin=' + typeof doLogin);
} catch(e) {
